    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-purple-500 rounded-2xl shadow-lg shadow-purple-500/40 mb-4">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-purple-500/20 border border-purple-500/30 rounded-full mb-3">
            ...
            <span className="text-purple-300 text-xs font-semibold uppercase tracking-wider">Admin Access</span>
          </div>
          <h1 className="text-2xl font-bold text-white">Create Admin Account</h1>
          <p className="text-slate-400 mt-1 text-sm">Register as a new administrator</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <Button type="submit" fullWidth loading={loading} className="mt-2 !bg-purple-600 hover:!bg-purple-700 focus:!ring-purple-500">
